...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            //  even when i move it the object pointer will not change
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge)); // here i have moved the ownership from chatlogic to graph nodes 
    ...
    ChatBot chatB = ChatBot("../images/chatbot.png");
